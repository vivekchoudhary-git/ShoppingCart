...
<title>sell-stats.jsp (seller)</title>
...
<h2 style="color:black">[ ${sellerOrdersCount} ]</h2>
</div>
</div>
</a>
</div>
...
<h2 style="color:black">[ ${sellerDeliveredOrdersCount} ]</h2>
</div>
</div>
</a>
</div>
...
<h2 style="color:black">[ ${sellerPendingOrdersCount} ]</h2>
</div>
</div>
</a>
</div>
...
<h2 style="color:black">[ ${sellerCancelledOrdersCount} ]</h2>
</div>
</div>
</a>
</div>
...
<h2 style="color:black">[ <i class="fa-solid fa-indian-rupee-sign fa-xs"></i>  ${revenueOfSeller} ]</h2>
</div>
</div>
</a>
</div>
