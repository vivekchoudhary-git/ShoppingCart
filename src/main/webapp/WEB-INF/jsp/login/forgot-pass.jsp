...
<!-- ends : show success messages -->

</div>
<div class="card-body">
<form action="/forgotPassEmail">

<div class="mb-3">
<label class="form-label">Email</label><input class="form-control" name="email" type="email" placeholder="Enter your email">
</div>


<button type="submit" class="btn bg-primary text-white col-md-4 offset-md-4">Send</button>
